...
export class UsersService {
  ...
  //Creamos la propiedad baseUrl, ya que en este caso de ahí deriban todas las demás rutas.
  ...
  getById(id: string): Promise<User | any> {
    //Petición del usuario a la API por el id.
  ...
  getAllP2(): Promise<InitialInfo> {
    //petición a la API para obtener todos los usuarios de la página 2 ya que trasteando no he hallado otra manera de poder obtener esa información debido a un error en la API. Se realiza por promesa.
